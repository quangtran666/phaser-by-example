...
export default class FoeGenerator {
  ...
  // @ts-ignore
  private waveFoes: Phaser.GameObjects.Sprite[];
  private activeWave: boolean;
  private waves: number;
  private path?: Phaser.Curves.Path;
  private graphics?: Phaser.GameObjects.Graphics;
  private generateEvent1?: Phaser.Time.TimerEvent;
  private generateEvent2?: Phaser.Time.TimerEvent;
  private generateEvent3?: Phaser.Time.TimerEvent;
  private generateEvent4?: Phaser.Time.TimerEvent;
  // @ts-ignore
  private laughterEvent?: Phaser.Time.TimerEvent;
