...
import { SplashScene } from "../types";

export default class Splash extends Phaser.Scene implements SplashScene {
  public width!: number;
  ...
  private gameLogoShadow!: Phaser.GameObjects.Image;
  private gameLogo!: Phaser.GameObjects.Image;
  private space!: Phaser.GameObjects.BitmapText;
