...
import { Scores, AudioMap, SceneData } from '../types';
import { GameScene } from '../types';

export class Game extends Phaser.Scene implements GameScene {
  public width!: number;
  public height!: number;
  public center_width!: number;
  public center_height!: number;
  public player!: Player | null;
  public shots!: Phaser.GameObjects.Group;
  public foeGroup!: Phaser.GameObjects.Group;
  public foeWaveGroup!: Phaser.GameObjects.Group;
  public foeShots!: Phaser.GameObjects.Group;
  public trailLayer!: Phaser.GameObjects.Layer;
  public shotsLayer!: Phaser.GameObjects.Layer;
  ...
  private shake!: PowerUp;
  // @ts-ignore
  private scoreText: Phaser.GameObjects.BitmapText | null;
  private scores!: Scores;
  private audios!: AudioMap;
  private available!: string[];
  private foes!: FoeGenerator;
  private currentPowerUp!: number;
  private lastDestroyedWaveFoe!: {x: number, y: number};
  ...
  /*
    ...
    */
  create() {
    this.duration = this.time.now * 1000;
  ...
  finishScene() {
    ...
    const scene = Number(this.number) < 5 ? "transition" : "outro";
